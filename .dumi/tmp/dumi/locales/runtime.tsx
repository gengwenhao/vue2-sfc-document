...
import { RawIntlProvider, createIntl, createIntlCache } from 'E:/all_projects/vue2-sfc-document/node_modules/.store/react-intl@6.5.5/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from 'E:/all_projects/vue2-sfc-document/node_modules/.store/dumi@2.2.14/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/gengwenhao/vuie2-sfc-document/edit/master/{filename}";
